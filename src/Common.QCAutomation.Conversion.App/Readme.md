...
Execute unit tests
```
    cd "Common.QCAutomation.Conversion.App/test/Common.QCAutomation.Conversion.App.Tests"
    dotnet test
```

Deploy application
```
    cd "Common.QCAutomation.Conversion.App/src/Common.QCAutomation.Conversion.App"
...
This automatically handles reading parameters from an APIGatewayHttpApiV2ProxyRequest and returning an APIGatewayHttpApiV2ProxyResponse. 
